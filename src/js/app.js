...
class App {
    ...
    addGroupParticles(elementTypeId,x, y, px, py){
        var that = this;
    ...
    drawArc(x, y, radius, startAngle, endAngle){
        ...
        this.arc = {
            ...
            draw: function () {
                that.ctx.beginPath();
                that.ctx.arc(this.x, this.y, this.radius, settings.degreesToRadians(startAngle), settings.degreesToRadians(endAngle), false);
                that.ctx.stroke();
            }
        };
